...
from src.models.db_schemes.data_scheme import ProcessRequest
from src.models.db_schemes.data_chunk import DataChunk
from src.models.db_schemes.asset_scheme import Asset
...
async def process_endpoint(request:Request,project_id:str , process_request:ProcessRequest):
    ...
    for _id,file_id in project_files_ids.items():
        ...
        if file_content is None:
            logger.error(f"Erorr while processing file :{file_id}")
            continue
